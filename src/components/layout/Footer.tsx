...
export function Footer({ className }: FooterProps) {
    return (
        <footer
            className={cn(
                "w-full bg-botanical text-moon-ivory/65 select-none border-t border-white/5",
                className,
            )}
        >
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 gap-x-8 md:gap-x-12 pb-16 md:pb-24">
                    ...
                    <div className="md:col-span-5 flex flex-col gap-6 md:pr-8">
                        ...
                        <p className="font-sans font-light text-[0.88rem] leading-[1.8] text-moon-ivory/80 max-w-[340px] tracking-wide">
                            Skin, hair and dental care designed around you -
                            guided by clinical experience, precision ethics, and
                        ...
                        <div className="flex flex-col gap-4 font-sans font-light text-[0.85rem]">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <span className="leading-[1.6] max-w-[280px]">
                                    #5, Rest House Crescent Road, off Kasturba
                                    Cross Road, Ashok Nagar, Bengaluru 560001
                                </span>
                            </div>
                            ...
                            <div className="flex flex-col gap-2 pt-2 border-t border-white/5">
                                ...
                                <a
                                    href="mailto:22lunaskin@gmail.com"
                                    className="flex items-center gap-3 hover:text-white transition-colors duration-300"
                                >
                                    <Mail
                                        size={14}
                                        className="text-gold shrink-0"
                                    />
                                    <span>22lunaskin@gmail.com</span>
                                </a>
                            </div>
