...
const PROGRAMS: ProgramItem[] = [
  ...
  },
  {
    ...
    publicId: 'wellness_mit4vq', // Wellness image public ID
  },
];
// ─────────────────────────────────────────────────────────
        ...
        <div className="lg:col-span-7 flex flex-col justify-center">
          ...
          >
            ...
            <h2 className="font-display leading-[1.05] tracking-tight text-charcoal">
              <span className="block text-[2rem] md:text-[2.5rem] font-light">OUR SIGNATURE</span>
              <span className="block text-[2rem] md:text-[2.5rem] text-botanical font-medium">PROGRAMS</span>
            </h2>
          </motion.div>
                ...
                >
                  ...
                  <div
                    className={cn(
                      ...
                      isActive && "scale-y-100 origin-top"
                    )}
                  />
                  ...
                  <div className="flex items-start justify-between relative z-10">
                    ...
                    <span
                      className={cn(
                        ...
                        isActive ? "text-charcoal/80" : "text-charcoal/10 group-hover:text-charcoal/30"
                      )}
                    >
                      {program.id}
                    </span>
