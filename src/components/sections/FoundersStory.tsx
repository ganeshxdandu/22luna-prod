...
export function FoundersStory({ className }: FoundersStoryProps) {
  return (
    ...
    >
      ...
      {/* ── Desktop Absolute positioned components (Quote left top, paragraph right bottom) ── */}
      {/* Left Column: Quote block */}
      <div className="w-full lg:w-[32%] lg:max-w-[420px] lg:absolute lg:left-8 lg:top-[30%] z-20 shrink-0 mt-14 lg:mt-0">
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
      ...
      <div className="w-full lg:w-[34%] lg:max-w-[380px] lg:absolute lg:right-8 lg:bottom-24 z-20 shrink-0 flex flex-col items-start text-left mt-16 lg:mt-0">
        <motion.div
          variants={fadeUp}
          initial="hidden"
          whileInView="visible"
