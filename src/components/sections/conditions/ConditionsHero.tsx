      ...
      <div className="max-w-site mx-auto w-full px-6 md:px-8 pt-[96px] md:pt-[112px] pb-16 md:pb-20">
        ...
        <div className="flex flex-col lg:flex-row items-start gap-10 lg:gap-20">
          ...
          <motion.h1
            ...
            className="font-display text-charcoal uppercase leading-[1.0] tracking-[-0.03em] text-[2.5rem] sm:text-[3rem] lg:text-[3.5rem] font-normal w-full lg:w-[50%] shrink-0"
          >
            Understanding your concern is the first step.
          </motion.h1>

          {/* Intro + CTA */}
          <div className="w-full lg:w-[44%] flex flex-col gap-7">
            <motion.p
              variants={fadeUp}
              initial="hidden"
              animate="visible"
            ...
            >
              You do not need to memorize treatment names or self-diagnose before reaching out. Whether you notice dullness, fine lines, thinning hair, or smile asymmetry — start with what you observe. We help you understand the underlying cause and guide you toward the right clinical approach.
            </motion.p>
