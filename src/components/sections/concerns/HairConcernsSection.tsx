...
import { HAIR_CONCERNS } from '@/lib/concerns-catalogue';
import { ConcernCard } from './ConcernCard';

export interface HairConcernsSectionProps {
  className?: string;
}

export function HairConcernsSection({ className }: HairConcernsSectionProps) {
  return (
    <section
      id="hair-concerns"
