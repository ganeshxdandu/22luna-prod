      ...
      <div className="max-w-site mx-auto w-full px-6 md:px-8">
        ...
        <div className="pt-8 pb-16 md:pb-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mt-8">
            ...
            >
              <div>
                <span className="font-display text-charcoal text-2xl font-light leading-none block">08</span>
                <span className="font-sans text-[0.65rem] tracking-[0.18em] uppercase text-stone-gray font-medium">Signature Procedures</span>
              </div>
